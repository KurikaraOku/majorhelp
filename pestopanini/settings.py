"""
Django settings for pestopanini project.
...
WSGI_APPLICATION = 'pestopanini.wsgi.application'
...
CSRF_TRUSTED_ORIGINS = ['https://majorhelp.onrender.com']
